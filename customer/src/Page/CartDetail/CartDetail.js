...
const CartDetail = () => {
    ...
    const checkPayos = () => {
        if (selectedProductCheckout.length > 0) {
            if (customer !== null) {
                const body = { note: note, total: finalTotal, items: selectedProductCheckout[0], customer: customer, address: addressSelected };
                                        ...
                                        <div className={cx('detail-cart-content-item')}>
                                            ...
                                            <div className={cx('checkPriceAndquantity')}>
                                                ...
                                                <div className={cx('quantity')}>
                                                    ...
                                                    }} className={cx("ProductDetail-content-Remove")}>
                                                        <RemoveIcon />
                                                    </span>
                                            ...
                                            <div className={cx("detail-cart-content-remove")}  >
                                                <DeleteOutlineOutlinedIcon onClick={() => lnkRemoveClick(item.product._id)} className={cx("detail-cart-content-remove-icon")} />
                                            </div>
                                        </div>
                                    )
                                } else {

                                    return (<div className={cx('detail-cart-content-item')}>
                                        <input
                                            type="checkbox"
                                            value={item}
                                            checked={selectedProductCheckout.includes(item)}
