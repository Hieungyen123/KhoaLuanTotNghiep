                ...
                <div className={cx('Content')}>
                    ...
                    <div className={cx('Cart')}>
                        <div className={cx('Price')}>
                            {Object.keys(product.promotion).length !== 0 && <p style={{ color: '#1250dc' }} className={cx('Cost')}>{discountPrice}.000 VNĐ</p>}
